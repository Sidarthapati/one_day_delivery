...
/**
 * Uniform error envelope for the sla API (RFC-7807 ProblemDetail). Extends Spring's base so all
 ...
 */
@RestControllerAdvice(basePackages = "com.oneday.sla")
class SlaExceptionHandler extends ResponseEntityExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(SlaExceptionHandler.class);
    ...
    Object handleUnexpected(Exception ex) throws Exception {
        ...
        log.error("Unhandled exception in sla API", ex);
