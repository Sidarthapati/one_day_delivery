...
public class E2eSecurityConfig {
    ...
    SecurityFilterChain e2eSecurityChain(HttpSecurity http,
        ...
        return http
                ...
                // Authorization/X-Api-Key headers, never cookies. Keep CSRF enabled but ignore
                // these stateless endpoints (equivalent to disabling here, but no blanket disable).
