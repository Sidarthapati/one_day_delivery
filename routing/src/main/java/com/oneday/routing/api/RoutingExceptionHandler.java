...
/**
 * Uniform error envelope for the routing API (RFC-7807 ProblemDetail). Extends Spring's base so all
 ...
 */
@RestControllerAdvice(basePackages = "com.oneday.routing")
class RoutingExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    Object handleUnexpected(Exception ex) throws Exception {
        ...
        log.error("Unhandled exception in routing API", ex);
