...
/**
 * Uniform error envelope for the shuttle API (RFC-7807 ProblemDetail). Extends Spring's base so all
 ...
 */
@RestControllerAdvice(basePackages = "com.oneday.shuttle")
class ShuttleExceptionHandler extends ResponseEntityExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(ShuttleExceptionHandler.class);
    ...
    Object handleUnexpected(Exception ex) throws Exception {
        ...
        log.error("Unhandled exception in shuttle API", ex);
