...
// Display-only. "Generate territories" in App already runs replan → approve → activate, so there is
// no separate approve action here (re-approving an APPROVED proposal is an error). Status is driven
// entirely by the prop.
    ...
    <div className="p-4 border-t border-gray-200">
      ...
      {status === 'APPROVED' && (
        <div className="text-center text-green-700 text-sm font-medium py-2">
          Territories approved &amp; LIVE — ready for routing
        </div>
      )}
