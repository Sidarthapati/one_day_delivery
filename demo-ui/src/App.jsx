...
import JourneyView from './components/journey/JourneyView.jsx'
...
export default function App() {
  ...
  const [view, setView] = useState('planning') // planning | execution | journey
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-4 px-4 py-2 bg-white border-b border-gray-200 shadow-sm z-10">
        <div className="font-bold text-gray-800">OneDay — {view === 'journey' ? 'M7 Journey' : view === 'execution' ? 'M6 Execution' : 'M6 Route Planning'}</div>
        {view !== 'journey' && (
        ...
        <div className="flex gap-1 ml-1">
          {[['planning', 'Planning'], ['execution', 'Execution'], ['journey', 'Journey']].map(([k, label]) => (
