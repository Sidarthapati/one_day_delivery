...
Stack: **Java 21 + Spring Boot 3.2**, **Maven multi-module**, **PostgreSQL**, **RabbitMQ** (CloudAMQP). Frontend (React) comes later.
...
|-----------|--------|------------|
| `common` | Shared infra: `BaseEntity`, event topics, shared event POJOs | — |
...
| `sla` | M10 — Per-leg SLA state (GREEN/AMBER/RED); RabbitMQ consumer | common, orders, barcode |
