...
/**
 * Uniform error envelope for the dispatch API (RFC-7807 ProblemDetail). Extends Spring's base so all
 ...
 */
@RestControllerAdvice(basePackages = "com.oneday.dispatch")
class DispatchExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    Object handleUnexpected(Exception ex) throws Exception {
        ...
        log.error("Unhandled exception in dispatch API", ex);
